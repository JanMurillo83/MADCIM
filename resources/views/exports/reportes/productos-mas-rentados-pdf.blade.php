...
<head>
    <meta charset="UTF-8">
    <title>Productos Mas Rentados</title>
    <style>
...
<body>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-right">Importe deposito</th>
            </tr>
        </thead>
        <tbody>
            @foreach($productos as $row)
                <tr>
                    ...
                    <td class="text-right">${{ number_format($row['importe_renta'], 2) }}</td>
                    <td class="text-right">${{ number_format($row['importe_deposito'], 2) }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div class="totales">
        <table>
            ...
            <tr>
                <td>Importe renta</td>
                <td class="text-right">${{ number_format($totals['importe_renta'], 2) }}</td>
            </tr>
            <tr>
                <td>Importe deposito</td>
                <td class="text-right">${{ number_format($totals['importe_deposito'], 2) }}</td>
            </tr>
        </table>
    </div>
</body>
