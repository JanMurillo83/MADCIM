...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <div class="document-title">RECEPCION DE COMPRA</div>
            <div class="document-number">{{ $recepcion->serie }}-{{ $recepcion->folio }}</div>
        </div>
    </div>
        ...
        <div class="info-right">
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    {{ optional($recepcion->fecha_emision)->format('d/m/Y') }}
                </div>
                <div class="info-row">
    ...
    <div class="totals-section clearfix">
        <table class="totals-table">
            <tr>
                ...
                <td class="value-col">${{ number_format($recepcion->subtotal, 2) }}</td>
            </tr>
            <tr>
                <td class="label-col">IVA</td>
                <td class="value-col">${{ number_format($recepcion->impuestos_total, 2) }}</td>
            </tr>
            <tr class="grand-total">
                <td class="label-col">TOTAL</td>
                <td class="value-col">${{ number_format($recepcion->total, 2) }}</td>
            </tr>
        </table>
    </div>
