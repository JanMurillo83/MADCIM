...
<head>
    ...
    <title>Nota de Venta {{ $notaVenta->serie }}-{{ $notaVenta->folio }}</title>
    <style>
        @page {
            margin: 1.5cm;
        }
...
<body>
        ...
        <div class="info-left">
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    {{ $notaVenta->cliente->nombre }}
                </div>
                @if($notaVenta->cliente->rfc)
                <div class="info-row">
                    <span class="info-label">RFC:</span>
                    {{ $notaVenta->cliente->rfc }}
                </div>
                @endif
                @if($notaVenta->cliente->direccion)
                <div class="info-row">
                    <span class="info-label">Dirección:</span>
                    {{ $notaVenta->cliente->direccion }}
                </div>
                @endif
                @if($notaVenta->cliente->telefono)
                <div class="info-row">
        ...
        <div class="info-right">
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    {{ $notaVenta->fecha_emision->format('d/m/Y') }}
                </div>
                <div class="info-row">
    ...
    <div class="observations">
        ...
        <div>{{ $notaVenta->observaciones }}</div>
    </div>
    @endif
