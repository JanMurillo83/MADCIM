...
<body>
    ...
    <div class="info-section">
        <div class="info-row">
            ...
            <span>{{ $cotizacion->serie }}-{{ $cotizacion->folio }}</span>
        </div>
        <div class="info-row">
        ...
        <div class="info-row">
            <span class="label">Días de Renta:</span>
            <span>{{ $cotizacion->dias_renta }}</span>
        </div>
        @endif
    </div>
    ...
    <div class="totals">
        ...
        <div class="total-row">
            ...
            <span>${{ number_format($cotizacion->impuestos_total, 2) }}</span>
        </div>
