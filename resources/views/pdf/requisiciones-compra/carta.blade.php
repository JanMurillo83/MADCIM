...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <div class="document-title">REQUISICION DE COMPRA</div>
            <div class="document-number">{{ $requisicion->serie }}-{{ $requisicion->folio }}</div>
        </div>
    </div>
        ...
        <div class="info-left">
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    {{ $requisicion->proveedor->nombre ?? 'N/A' }}
                </div>
                <div class="info-row">
                    <span class="info-label">RFC:</span>
                    {{ $requisicion->proveedor->rfc ?? 'N/A' }}
                </div>
            </div>
        </div>
    ...
    <div class="totals-section clearfix">
        <table class="totals-table">
            <tr>
                ...
                <td class="value-col">${{ number_format($requisicion->subtotal, 2) }}</td>
            </tr>
            <tr>
                <td class="label-col">IVA</td>
                <td class="value-col">${{ number_format($requisicion->impuestos_total, 2) }}</td>
            </tr>
            <tr class="grand-total">
                <td class="label-col">TOTAL</td>
                <td class="value-col">${{ number_format($requisicion->total, 2) }}</td>
            </tr>
        </table>
    </div>
