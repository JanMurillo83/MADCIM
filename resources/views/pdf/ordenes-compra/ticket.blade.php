...
<body>
    ...
    <div class="info-section">
        <div class="info-row">
            ...
            <span>{{ $orden->serie }}-{{ $orden->folio }}</span>
        </div>
        <div class="info-row">
            <span class="label">Fecha:</span>
            <span>{{ optional($orden->fecha_emision)->format('d/m/Y') }}</span>
        </div>
        <div class="info-row">
            <span class="label">Proveedor:</span>
            <span>{{ $orden->proveedor->nombre ?? 'N/A' }}</span>
        </div>
    </div>
    ...
    <div class="totals">
        ...
        <div class="total-row">
            ...
            <span>${{ number_format($orden->impuestos_total, 2) }}</span>
        </div>
