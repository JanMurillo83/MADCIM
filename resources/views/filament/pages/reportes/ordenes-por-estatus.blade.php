    ...
    <div class="space-y-6">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($this->ordenes as $orden)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-2">{{ $orden->serie }}-{{ $orden->folio }}</td>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl p-4 shadow border border-gray-200">
                <p class="text-sm text-gray-500">Total ordenes</p>
                <p class="text-2xl font-bold text-gray-800">{{ $this->totalOrdenes }}</p>
            </div>
            <div class="bg-white rounded-xl p-4 shadow border border-gray-200">
