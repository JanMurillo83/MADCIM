    ...
    <div class="space-y-6">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left text-gray-600">Vencimiento</th>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl p-4 shadow border border-gray-200">
                <p class="text-sm text-gray-500">Total rentas</p>
                <p class="text-2xl font-bold text-gray-800">${{ number_format($this->totalRentas, 2) }}</p>
            </div>
            <div class="bg-white rounded-xl p-4 shadow border border-gray-200">
