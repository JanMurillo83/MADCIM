    ...
    <div class="space-y-6">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-right text-gray-600">Dias vencido</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        @forelse($this->cuentas as $row)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-right">{{ $row['dias_vencido'] }}</td>
                            </tr>
                        @empty
                            <tr>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl p-4 shadow border border-gray-200">
                <p class="text-sm text-gray-500">Saldo pendiente total</p>
