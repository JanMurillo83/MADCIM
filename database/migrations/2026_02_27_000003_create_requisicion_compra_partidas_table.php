...
return new class extends Migration
{
    ...
    {
        Schema::create('requisicion_compra_partidas', function (Blueprint $table) {
            $table->id();
            $table->foreignId('requisicion_compra_id')
                ->constrained('requisiciones_compra')
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('requisicion_compra_partidas');
    }
};
